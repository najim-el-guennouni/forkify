...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var x=Function.prototype.call;F=M?x.bind(x):function(){return x.apply(x,arguments)};var P={}.propertyIsEnumerable,T=Object.getOwnPropertyDescriptor;o=T&&!P.call({1:2},1)?function(e){var t=T(this,e);return!!t&&t.enumerable}:P;var I={};I=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var q={},D={},N={},H=Function.prototype,C=H.call,A=M&&H.bind.bind(C,C),R={},W=(N=M?A:function(e){return function(){return C.apply(e,arguments)}})({}.toString),z=N("".slice);R=function(e){return z(W(e),8,-1)};var U=Object,G=N("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
D=L(function(){// throws an error in rhino, see https://github.com/mozilla/rhino/issues/346
...
B=function(e){if(J(e))throw new Y("Can't call method on "+e);return e},q=function(e){return D(B(e))};var Q={},V={},K={},X={},Z={},ee="object"==typeof document&&document.all,et=(Z={all:ee,IS_HTMLDDA:void 0===ee&&void 0!==ee}).all;// `IsCallable` abstract operation
...
eF=Object.hasOwn||function(e,t){return eP(eM(e),t)};var eT={},eI=0,eq=Math.random(),eD=N(1..toString);eT=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eD(++eI+eq,36)};var eN=O.Symbol,eH=eE("wks"),eC=ea?eN.for||eN:eN&&eN.withoutSetter||eT,eA=TypeError,eR=(eF(eH,e="toPrimitive")||(eH[e]=es&&eF(eN,e)?eN[e]:eC("Symbol."+e)),eH[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
V=function(e,t){if(!K(e)||en(e))return e;var r,n=eg(e,eR);if(n){if(void 0===t&&(t="default"),r=F(n,e,t),!K(r)||en(r))return r;throw new eA("Can't convert object to primitive value")}return void 0===t&&(t="number"),ew(e,t)},// `ToPropertyKey` abstract operation
...
var tD=function(e){return function(t,r,n){var i,o=q(t),a=tT(o),s=t$(n,a);// Array#includes uses SameValueZero equality algorithm
...
indexOf:tD(!1)}.indexOf,tH=N([].push);tO=function(e,t){var r,n=q(e),i=0,o=[];for(r in n)!eF(ta,r)&&eF(n,r)&&tH(o,r);// Don't enum bug & hidden keys
for(;t.length>i;)eF(n,r=t[i++])&&(~tN(o,r)||tH(o,r));return o};var tC=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");p=Object.getOwnPropertyNames||function(e){return tO(e,tC)},f=Object.getOwnPropertySymbols;var tA=N([].concat);// all object keys, includes non-enumerable and symbols
tS=ei("Reflect","ownKeys")||function(e){var t=p(eQ(e));return f?tA(t,f(e)):t},tE=function(e,t,r){for(var n=tS(t),o=0;o<n.length;o++){var a=n[o];eF(e,a)||r&&eF(r,a)||c(e,a,i(t,a))}};var tR={},tW=/#|\.prototype\./,tz=function(e,t){var r=tG[tU(e)];return r===tJ||r!==tB&&(X(t)?L(t):!!t)},tU=tz.normalize=function(e){return String(e).replace(tW,".").toLowerCase()},tG=tz.data={},tB=tz.NATIVE="N",tJ=tz.POLYFILL="P";tR=tz,/*
...
tZ=function(e,t){return em(e),void 0===t?e:M?t1(e,t):function(){return e.apply(t,arguments)}};var t2={};t2=ei("document","documentElement");var t3={};t3=N([].slice);var t4={},t9=TypeError;t4=function(e,t){if(e<t)throw new t9("Not enough arguments");return e};var t7={};// eslint-disable-next-line redos/no-vulnerable -- safe
t7=/(?:ipad|iphone|ipod).*applewebkit/i.test(eu);var t8={};t8="process"===R(O.process);var t5=O.setImmediate,t6=O.clearImmediate,re=O.process,rt=O.Dispatch,rr=O.Function,rn=O.MessageChannel,ri=O.String,ro=0,ra={},rs="onreadystatechange";L(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
...
O.postMessage(ri(e),h.protocol+"//"+h.host)};t5&&t6||(t5=function(e){t4(arguments.length,1);var t=X(e)?e:rr(e),r=t3(arguments,1);return ra[++ro]=function(){tQ(t,void 0,r)},v(ro),ro},t6=function(e){delete ra[e]},t8?v=function(e){re.nextTick(ru(e))}:rt&&rt.now?v=function(e){rt.now(ru(e))}:rn&&!t7?(m=(g=new rn).port2,g.port1.onmessage=rl,v=tZ(m.postMessage,m)):O.addEventListener&&X(O.postMessage)&&!O.importScripts&&h&&"file:"!==h.protocol&&!L(rd)?(v=rd,O.addEventListener("message",rl,!1)):v=rs in ez("script")?function(e){t2.appendChild(ez("script"))[rs]=function(){t2.removeChild(this),rc(e)}}:function(e){setTimeout(ru(e),0)});var rp=(tY={set:t5,clear:t6}).clear;// `clearImmediate` method
...
"object"==typeof globalThis?globalThis.regeneratorRuntime=rb:Function("r","regeneratorRuntime = r")(rb)}const r_="https://forkify-api.herokuapp.com/api/v2/recipes/",rw="73f983dc-f9ed-4c50-a030-68ec1adbae90",rk=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 10 second"))},1e4)})]),i=await n.json();if(!n.ok)throw Error(`${i.message} (${n.status})`);return i}catch(e){throw e}},rE={recipe:{},search:{query:"",results:[],page:1,resultsPerPage:10},bookmarks:[]},rS=function(e){let{recipe:t}=e.data;return{id:t.id,title:t.title,publisher:t.publisher,sourceUrl:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},rO=async function(e){try{let t=await rk(`${r_}${e}?key=${rw}`);rE.recipe=rS(t),rE.bookmarks.some(t=>t.id===e)?rE.recipe.bookmarked=!0:rE.recipe.bookmarked=!1}catch(e){throw console.error(`${e} ⚠️`),e}},r$=async function(e){try{rE.search.query=e;let t=await rk(`${r_}?search=${e}&key=${rw}`);rE.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),rE.search.page=1}catch(e){throw console.error(`${e} ⚠️`),e}},rj=function(e=rE.search.page){rE.search.page=e;let t=(e-1)*rE.search.resultsPerPage,r=e*rE.search.resultsPerPage;//0
return rE.search.results.slice(t,r)},rL=function(e){rE.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/rE.recipe.servings;// newQt = oldQt * new Serving / olderServing
...
let t=e[1].split(",").map(e=>e.trim());if(3!==t.length)throw Error("Wrong ingredient fromat! please use the correct format :) ");let[r,n,i]=t;return{quantity:r?+r:0,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await rk(`${r_}?key=${rw}`,r);rE.recipe=rS(n),rM(rE.recipe);// console.log(data);
}catch(e){throw e}};var rT={};rT=new URL(E("27Lyk").resolve("eyyUD"),import.meta.url).toString();class rI{_data;/**
   * Render the recived obkect to the DOM
...
return 1!=t&&r.push(t),r;// Return the prime factors
    ...
    <figure class="recipe__fig">
        ...
        <div class="recipe__details">
          ...
          <button class="btn--round btn--booknark">
            <svg class="">
    ...
    `}_generateMarkupIngredient(e){return`
          ...
          `}}var rD=new rq;class rN{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){return this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rH=new rN,rC=new class extends rI{_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`
        <li class="preview">
...
1===e&&t>1?`
          ...
          `:"")}}var rz=new rW;class rU extends rI{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it ";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rC.render(e,!1)).join("")}}var rG=new rU;class rB extends rI{_parentElement=document.querySelector(".upload");_message="Recipe was successfully uploaded :)";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");constructor(){super(),this._addhandlerShowWindow(),this._addhandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addhandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addhandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}_generateMarkup(){}}var rJ=new rB;const rY=async function(){try{// resultsView.renderSpinner();
let e=window.location.hash.slice(1);// console.log(id);
if(!e)return;rD.renderSpinner(),rR.update(rj()),rG.update(rE.bookmarks),// 1) Loading recip
await rO(e),rD.render(rE.recipe)}catch(e){console.log(e),rD.renderError()}},rQ=async function(){try{rR.renderSpinner();let e=rH.getQuery();if(!e)return;// 2) Load search results
await r$(e),rR.render(rj(1)),rz.render(rE.search)}catch(e){console.log(e)}},rV=async function(e){try{rJ.renderSpinner(),await rP(e),rD.render(rE.recipe),rJ.renderMessage(),rG.render(rE.bookmarks),//Change Id in URL
window.history.pushState(null,"",`#${rE.recipe.id}`),// window.history.back()
//close form window
setTimeout(function(){rJ.toggleWindow()},2500)}catch(e){console.log("\uD83E\uDD2C\uD83E\uDD2C\uD83E\uDD2C".err),rJ.renderError(e.message)}};rG.addHandlerRender(function(){rG.render(rE.bookmarks)}),rD.addHandlerRender(rY),rD.addHandlerUpdateServings(function(e){// Update the recipe serving ( in state )
rL(e),rD.update(rE.recipe)}),rD.addHandlerAddBookmark(function(){rE.recipe.bookmarked?rx(rE.recipe.id):rM(rE.recipe),rD.update(rE.recipe),rG.render(rE.bookmarks)}),rH.addHandlerSearch(rQ),rz.addHandlerClick(function(e){rR.render(rj(e)),rz.render(rE.search)}),rJ.addHandlerUpload(rV);//# sourceMappingURL=index.5fb1f87d.js.map

//# sourceMappingURL=index.5fb1f87d.js.map
